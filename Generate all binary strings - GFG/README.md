...
<pre style="position: relative;"><span style="font-size:18px"><strong>Example 1:</strong></span>
...
None of the above strings contain consecutive 1s. "110" is not an answer as it has '1's occuring consecutively. </span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
